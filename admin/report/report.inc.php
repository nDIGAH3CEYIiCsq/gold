 ...
 * @version 1.0.1
 */
class AdminReport extends ComponentAdmin
{
	public function initialize()
	{
		parent::initialize();

		$this->Templates->set_base_path("Панель администрирования/Отчет");
		$this->Templates->set_template("Панель администрирования/Шаблоны/Страница");
	}

	public function get_services()
	{
		return array('index' => "Отчет");
	}
	...
	public function on_edit_item()
	{
		$fields = array('id'			=> array('filter' => FILTER_VALIDATE_INT),
				...
				'price_base'		=> array('filter' => FILTER_VALIDATE_INT),
